...
I have almost completed this challenge. There is only one thing missing, and that is color of toggle button
in light mode. Solution for that was note working because the toggle button was created by reference from
bootstrap forms. The css code behind background color contains pseudo element and it is not possible to
modify pseudo element by using jQuey or any other JavaScript,
Thank You.
